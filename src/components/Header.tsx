...
const Header = () => {
  const navigationItems = [
    ...
    { label: "HEARING HEALTH", href: "#hearing-health", hasDropdown: true },
    { label: "RAPID HEARING TEST", href: "#rapid-test" },
      ...
      <div className="container mx-auto px-4">
        <div className="flex items-center justify-between py-3 md:py-4">
          ...
          <div className="flex items-center gap-2 md:gap-3">
            ...
            <Button
              size="sm"
              className="bg-whatsapp hover:bg-whatsapp/90 text-white gap-2 hidden sm:flex"
            >
            ...
            <Button 
              variant="outline" 
              size="sm" 
              className="border-primary text-primary hover:bg-primary hover:text-primary-foreground hidden sm:flex"
            >
              Login
            </Button>
          </div>
        ...
        <nav className="border-t border-border hidden md:block">
          <ul className="flex items-center justify-center gap-1 lg:gap-6 py-3 overflow-x-auto scrollbar-hide">
